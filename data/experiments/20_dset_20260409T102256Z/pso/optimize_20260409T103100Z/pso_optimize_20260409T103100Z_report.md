# Отчёт по оптимизации: pso_optimize_20260409T103100Z

## Метаданные
- метод: `pso`
- датасет: `data/numbers/20_dset_20260409T102256Z/train.json`
- оптимум `(B1, B2)`: `(1000, 1000)`
- objective: `0.5919162365025841`
- curves_per_n: `12`
- границы: `B1[1000.0, 30000.0]`, `B2[1000.0, 600000.0]`, `ratio_max=20.0`

## Ключевые статистики
- `best_eval`: `198`
- `best_eval_fraction`: `0.8461538461538461`
- `eval_per_sec`: `4.619044840442933`
- `evaluation_count`: `234`
- `improvement_percent`: `34.73267041927926`
- `max_plateau_evals`: `108`
- `median_plateau_evals`: `9.0`
- `new_best_count`: `10`
- `new_best_rate`: `0.042735042735042736`
- `p90_plateau_evals`: `36.0`
- `time_to_best_sec`: `43.52179086499382`
- `time_to_first_improvement_sec`: `6.817303127027117`
- `total_runtime_sec`: `50.65992201899644`
...
| `late_best` | ⚠️ ВНИМАНИЕ | `0.8590970757648232` | `> 0.85` | Лучшее решение найдено слишком поздно относительно общего времени. | Усилить ранний поиск или пересмотреть бюджет/инициализацию. |
| `low_improvement` | ✅ ОК | `34.73267041927926` | `< 10%` | Итоговый прирост качества слишком мал. | Сузить границы поиска или изменить параметры метода. |
...
| `ratio_hits_boundary` | ⚠️ ВНИМАНИЕ | `0.8803418803418803` | `> 0.10` | Большая доля оценок проходит близко к границе отношения B2/B1. | Увеличить ratio_max, если хорошие точки упираются в ограничение отношения B2/B1. |

## Графики
- [`pso_optimize_20260409T103100Z_b1_b2_trajectory.png`](plots/pso_optimize_20260409T103100Z_b1_b2_trajectory.png)
![b1_b2_trajectory](plots/pso_optimize_20260409T103100Z_b1_b2_trajectory.png)
- [`pso_optimize_20260409T103100Z_b1_ratio_heatmap.png`](plots/pso_optimize_20260409T103100Z_b1_ratio_heatmap.png)
![b1_ratio_heatmap](plots/pso_optimize_20260409T103100Z_b1_ratio_heatmap.png)
- [`pso_optimize_20260409T103100Z_jump_plot.png`](plots/pso_optimize_20260409T103100Z_jump_plot.png)
![jump_plot](plots/pso_optimize_20260409T103100Z_jump_plot.png)
- [`pso_optimize_20260409T103100Z_progress_by_phase.png`](plots/pso_optimize_20260409T103100Z_progress_by_phase.png)
![progress_by_phase](plots/pso_optimize_20260409T103100Z_progress_by_phase.png)
- [`pso_optimize_20260409T103100Z_time_efficiency.png`](plots/pso_optimize_20260409T103100Z_time_efficiency.png)
![time_efficiency](plots/pso_optimize_20260409T103100Z_time_efficiency.png)
...
<script>
const tables = [
  { file: 'tables/pso_optimize_20260409T103100Z_events.csv' },
  { file: 'tables/pso_optimize_20260409T103100Z_new_best.csv' },
  { file: 'tables/pso_optimize_20260409T103100Z_phase_summary.csv' },
  { file: 'tables/pso_optimize_20260409T103100Z_run_summary.csv' },
];
