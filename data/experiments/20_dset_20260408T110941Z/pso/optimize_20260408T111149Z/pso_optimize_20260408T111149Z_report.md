# Отчёт по оптимизации: pso_optimize_20260408T111149Z

## Метаданные
- метод: `pso`
- датасет: `data/numbers/20_dset_20260408T110941Z/train.json`
- оптимум `(B1, B2)`: `(1000, 1000)`
- objective: `0.5756325463589747`
- curves_per_n: `12`
- границы: `B1[1000.0, 30000.0]`, `B2[1000.0, 600000.0]`, `ratio_max=20.0`

## Ключевые статистики
- `best_eval`: `228`
- `best_eval_fraction`: `0.9743589743589743`
- `eval_per_sec`: `5.039943011026296`
- `evaluation_count`: `234`
- `improvement_percent`: `37.447168541628436`
- `max_plateau_evals`: `87`
- `median_plateau_evals`: `6.0`
- `new_best_count`: `10`
- `new_best_rate`: `0.042735042735042736`
- `p90_plateau_evals`: `75.0`
- `time_to_best_sec`: `45.333000240963884`
- `time_to_first_improvement_sec`: `6.085018320998643`
- `total_runtime_sec`: `46.42916449898621`
...
| `late_best` | ⚠️ ВНИМАНИЕ | `0.9763906098709516` | `> 0.85` | Лучшее решение найдено слишком поздно относительно общего времени. | Усилить ранний поиск или пересмотреть бюджет/инициализацию. |
| `low_improvement` | ✅ ОК | `37.447168541628436` | `< 10%` | Итоговый прирост качества слишком мал. | Сузить границы поиска или изменить параметры метода. |
...
| `plateau_too_long` | ✅ ОК | `0.3717948717948718` | `> 0.50` | Слишком длинное плато: улучшений почти нет на большом участке запуска. | Увеличить exploration или добавить политику рестартов. |
...
## Графики
- [`pso_optimize_20260408T111149Z_b1_b2_trajectory.png`](plots/pso_optimize_20260408T111149Z_b1_b2_trajectory.png)
![b1_b2_trajectory](plots/pso_optimize_20260408T111149Z_b1_b2_trajectory.png)
- [`pso_optimize_20260408T111149Z_b1_ratio_heatmap.png`](plots/pso_optimize_20260408T111149Z_b1_ratio_heatmap.png)
![b1_ratio_heatmap](plots/pso_optimize_20260408T111149Z_b1_ratio_heatmap.png)
- [`pso_optimize_20260408T111149Z_jump_plot.png`](plots/pso_optimize_20260408T111149Z_jump_plot.png)
![jump_plot](plots/pso_optimize_20260408T111149Z_jump_plot.png)
- [`pso_optimize_20260408T111149Z_progress_by_phase.png`](plots/pso_optimize_20260408T111149Z_progress_by_phase.png)
![progress_by_phase](plots/pso_optimize_20260408T111149Z_progress_by_phase.png)
- [`pso_optimize_20260408T111149Z_time_efficiency.png`](plots/pso_optimize_20260408T111149Z_time_efficiency.png)
![time_efficiency](plots/pso_optimize_20260408T111149Z_time_efficiency.png)
...
<script>
const tables = [
  { file: 'tables/pso_optimize_20260408T111149Z_events.csv' },
  { file: 'tables/pso_optimize_20260408T111149Z_new_best.csv' },
  { file: 'tables/pso_optimize_20260408T111149Z_phase_summary.csv' },
  { file: 'tables/pso_optimize_20260408T111149Z_run_summary.csv' },
];
