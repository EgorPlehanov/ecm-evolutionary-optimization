...
## Навигация
- Путь: /[overview](../../../../../../report.md)/[divisor_size=20](../../../../report.md)/[dataset=20_dset_20260409T101157Z](../../report.md)/method=pso
- Переход на нижний уровень:
  - [seed=20011](groups/seed=20011/report.md)

## Краткая сводка
- запусков в области: **3**
- медиана final objective: **0.628248**
- IQR objective: **0.000647**
- доля успеха (`objective <= 0.678229`): **100.00%**
- медианное время выполнения: **49.969 сек**
- медианный прирост по validation: **35.025%**
