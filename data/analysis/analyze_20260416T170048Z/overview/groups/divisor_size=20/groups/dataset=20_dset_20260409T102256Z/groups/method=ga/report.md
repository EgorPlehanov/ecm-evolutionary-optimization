...
## Навигация
- Путь: /[overview](../../../../../../report.md)/[divisor_size=20](../../../../report.md)/[dataset=20_dset_20260409T102256Z](../../report.md)/method=ga
- Переход на нижний уровень:
  - [seed=30013](groups/seed=30013/report.md)

## Краткая сводка
- запусков в области: **3**
- медиана final objective: **0.633785**
- IQR objective: **0.002718**
- доля успеха (`objective <= 0.678229`): **100.00%**
- медианное время выполнения: **70.225 сек**
- медианный прирост по validation: **29.258%**
