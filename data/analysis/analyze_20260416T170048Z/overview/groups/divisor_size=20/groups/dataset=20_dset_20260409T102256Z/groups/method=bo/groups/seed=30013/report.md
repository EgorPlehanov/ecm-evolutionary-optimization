...
## Навигация
- Путь: /[overview](../../../../../../../../report.md)/[divisor_size=20](../../../../../../report.md)/[dataset=20_dset_20260409T102256Z](../../../../report.md)/[method=bo](../../report.md)/seed=30013
- Нижних уровней группировки нет.

## Краткая сводка
- запусков в области: **3**
- медиана final objective: **0.677820**
- IQR objective: **0.023950**
- доля успеха (`objective <= 0.678229`): **66.67%**
- медианное время выполнения: **11.276 сек**
- медианный прирост по validation: **32.198%**
