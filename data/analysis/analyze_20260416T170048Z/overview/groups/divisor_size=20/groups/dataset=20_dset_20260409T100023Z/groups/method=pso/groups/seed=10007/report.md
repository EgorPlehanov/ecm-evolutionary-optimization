...
## Навигация
- Путь: /[overview](../../../../../../../../report.md)/[divisor_size=20](../../../../../../report.md)/[dataset=20_dset_20260409T100023Z](../../../../report.md)/[method=pso](../../report.md)/seed=10007
- Нижних уровней группировки нет.

## Краткая сводка
- запусков в области: **3**
- медиана final objective: **0.700728**
- IQR objective: **0.046711**
- доля успеха (`objective <= 0.678229`): **33.33%**
- медианное время выполнения: **57.824 сек**
- медианный прирост по validation: **33.312%**
