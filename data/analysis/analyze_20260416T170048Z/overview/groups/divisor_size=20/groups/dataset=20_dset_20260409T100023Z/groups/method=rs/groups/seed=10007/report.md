...
## Навигация
- Путь: /[overview](../../../../../../../../report.md)/[divisor_size=20](../../../../../../report.md)/[dataset=20_dset_20260409T100023Z](../../../../report.md)/[method=rs](../../report.md)/seed=10007
- Нижних уровней группировки нет.

## Краткая сводка
- запусков в области: **3**
- медиана final objective: **0.787425**
- IQR objective: **0.018546**
- доля успеха (`objective <= 0.678229`): **0.00%**
- медианное время выполнения: **24.157 сек**
- медианный прирост по validation: **24.056%**
