...
## Навигация
- Путь: /[overview](../../../../../../../../report.md)/[divisor_size=30](../../../../../../report.md)/[dataset=30_dset_20260409T121414Z](../../../../report.md)/[method=bo](../../report.md)/seed=30013
- Нижних уровней группировки нет.

## Краткая сводка
- запусков в области: **3**
- медиана final objective: **0.966910**
- IQR objective: **0.037233**
- доля успеха (`objective <= 0.678229`): **0.00%**
- медианное время выполнения: **18.351 сек**
- медианный прирост по validation: **87.498%**
