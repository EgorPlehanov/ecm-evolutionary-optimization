...
## Навигация
- Путь: /[overview](../../../../../../report.md)/[divisor_size=30](../../../../report.md)/[dataset=30_dset_20260409T121414Z](../../report.md)/method=de
- Переход на нижний уровень:
  - [seed=30013](groups/seed=30013/report.md)

## Краткая сводка
- запусков в области: **3**
- медиана final objective: **0.916936**
- IQR objective: **0.027775**
- доля успеха (`objective <= 0.678229`): **0.00%**
- медианное время выполнения: **103.154 сек**
- медианный прирост по validation: **88.209%**
