...
## Навигация
- Путь: /[overview](../../../../../../../../report.md)/[divisor_size=30](../../../../../../report.md)/[dataset=30_dset_20260409T121414Z](../../../../report.md)/[method=pso](../../report.md)/seed=30013
- Нижних уровней группировки нет.

## Краткая сводка
- запусков в области: **3**
- медиана final objective: **0.855988**
- IQR objective: **0.042170**
- доля успеха (`objective <= 0.678229`): **0.00%**
- медианное время выполнения: **70.931 сек**
- медианный прирост по validation: **88.480%**
