...
## Навигация
- Путь: /[overview](../../../../../../../../report.md)/[divisor_size=30](../../../../../../report.md)/[dataset=30_dset_20260409T112558Z](../../../../report.md)/[method=bo](../../report.md)/seed=10007
- Нижних уровней группировки нет.

## Краткая сводка
- запусков в области: **3**
- медиана final objective: **0.960499**
- IQR objective: **0.079105**
- доля успеха (`objective <= 0.678229`): **0.00%**
- медианное время выполнения: **20.828 сек**
- медианный прирост по validation: **88.428%**
