...
## Навигация
- Путь: /[overview](../../../../../../report.md)/[divisor_size=30](../../../../report.md)/[dataset=30_dset_20260409T112558Z](../../report.md)/method=de
- Переход на нижний уровень:
  - [seed=10007](groups/seed=10007/report.md)

## Краткая сводка
- запусков в области: **3**
- медиана final objective: **0.921031**
- IQR objective: **0.024400**
- доля успеха (`objective <= 0.678229`): **0.00%**
- медианное время выполнения: **104.132 сек**
- медианный прирост по validation: **88.053%**
