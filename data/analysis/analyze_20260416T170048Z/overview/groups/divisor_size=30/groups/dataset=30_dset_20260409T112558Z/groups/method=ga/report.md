...
## Навигация
- Путь: /[overview](../../../../../../report.md)/[divisor_size=30](../../../../report.md)/[dataset=30_dset_20260409T112558Z](../../report.md)/method=ga
- Переход на нижний уровень:
  - [seed=10007](groups/seed=10007/report.md)

## Краткая сводка
- запусков в области: **3**
- медиана final objective: **0.950957**
- IQR objective: **0.032622**
- доля успеха (`objective <= 0.678229`): **0.00%**
- медианное время выполнения: **114.649 сек**
- медианный прирост по validation: **87.979%**
