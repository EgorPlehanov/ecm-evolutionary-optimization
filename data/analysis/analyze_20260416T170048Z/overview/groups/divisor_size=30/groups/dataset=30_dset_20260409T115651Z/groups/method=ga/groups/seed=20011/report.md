...
## Навигация
- Путь: /[overview](../../../../../../../../report.md)/[divisor_size=30](../../../../../../report.md)/[dataset=30_dset_20260409T115651Z](../../../../report.md)/[method=ga](../../report.md)/seed=20011
- Нижних уровней группировки нет.

## Краткая сводка
- запусков в области: **3**
- медиана final objective: **0.906748**
- IQR objective: **0.031605**
- доля успеха (`objective <= 0.678229`): **0.00%**
- медианное время выполнения: **97.402 сек**
- медианный прирост по validation: **87.486%**
