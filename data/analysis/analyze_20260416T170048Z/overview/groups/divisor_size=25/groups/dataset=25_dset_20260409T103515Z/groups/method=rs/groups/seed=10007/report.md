...
## Навигация
- Путь: /[overview](../../../../../../../../report.md)/[divisor_size=25](../../../../../../report.md)/[dataset=25_dset_20260409T103515Z](../../../../report.md)/[method=rs](../../report.md)/seed=10007
- Нижних уровней группировки нет.

## Краткая сводка
- запусков в области: **3**
- медиана final objective: **0.829505**
- IQR objective: **0.010551**
- доля успеха (`objective <= 0.678229`): **0.00%**
- медианное время выполнения: **28.304 сек**
- медианный прирост по validation: **56.889%**
