...
## Навигация
- Путь: /[overview](../../../../../../report.md)/[divisor_size=25](../../../../report.md)/[dataset=25_dset_20260409T103515Z](../../report.md)/method=bo
- Переход на нижний уровень:
  - [seed=10007](groups/seed=10007/report.md)

## Краткая сводка
- запусков в области: **3**
- медиана final objective: **0.838794**
- IQR objective: **0.018916**
- доля успеха (`objective <= 0.678229`): **0.00%**
- медианное время выполнения: **15.402 сек**
- медианный прирост по validation: **57.045%**
