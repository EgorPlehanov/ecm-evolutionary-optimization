...
## Навигация
- Путь: /[overview](../../../../../../../../report.md)/[divisor_size=25](../../../../../../report.md)/[dataset=25_dset_20260409T110755Z](../../../../report.md)/[method=bo](../../report.md)/seed=30013
- Нижних уровней группировки нет.

## Краткая сводка
- запусков в области: **3**
- медиана final objective: **0.752138**
- IQR objective: **0.008133**
- доля успеха (`objective <= 0.678229`): **0.00%**
- медианное время выполнения: **13.126 сек**
- медианный прирост по validation: **63.782%**
