...
## Навигация
- Путь: /[overview](../../../../../../../../report.md)/[divisor_size=25](../../../../../../report.md)/[dataset=25_dset_20260409T105031Z](../../../../report.md)/[method=bo](../../report.md)/seed=20011
- Нижних уровней группировки нет.

## Краткая сводка
- запусков в области: **3**
- медиана final objective: **0.760392**
- IQR objective: **0.028825**
- доля успеха (`objective <= 0.678229`): **0.00%**
- медианное время выполнения: **14.336 сек**
- медианный прирост по validation: **59.501%**
