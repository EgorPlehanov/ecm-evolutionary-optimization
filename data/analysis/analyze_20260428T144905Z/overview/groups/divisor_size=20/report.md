...
- медиана final objective: **-0.198326**
- IQR objective: **0.094293**
- доля успеха (`objective <= -0.273709`): **40.00%**
- медианное время выполнения: **739.557 сек**
- медианный прирост по validation: **-70.746%**

## Executive summary
- лучший сегмент по objective: **de**
- лучший сегмент по validation gain: **rs**
...
- [final_objective_by_method_dataset=20_dset_20260428T135130Z.png](plots/final_objective_by_method_dataset=20_dset_20260428T135130Z.png)
![final_objective_by_method_dataset=20_dset_20260428T135130Z](plots/final_objective_by_method_dataset=20_dset_20260428T135130Z.png)
