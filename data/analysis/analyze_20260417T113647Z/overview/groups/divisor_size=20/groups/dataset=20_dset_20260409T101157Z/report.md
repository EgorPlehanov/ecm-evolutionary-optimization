# Отчёт анализа: `dataset=20_dset_20260409T101157Z`

## Навигация
- Путь: /[overview](../../../../report.md)/[divisor_size=20](../../report.md)/dataset=20_dset_20260409T101157Z
...
- медиана final objective: **0.638765**
- IQR objective: **0.033189**
- доля успеха (`objective <= 0.678229`): **80.00%**
- медианное время выполнения: **49.969 сек**
- медианный прирост по validation: **33.171%**

## Executive summary
- лучший сегмент по objective: **pso**
- лучший сегмент по validation gain: **de**
- statistically significant пар: **0**
- кандидаты на adoption: **bo, de, ga, pso**
- кандидаты под наблюдение: **rs**
