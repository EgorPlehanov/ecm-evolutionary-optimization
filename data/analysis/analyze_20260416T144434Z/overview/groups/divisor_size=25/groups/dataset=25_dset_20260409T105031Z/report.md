# Отчёт анализа: `dataset=25_dset_20260409T105031Z`

## Навигация
- Путь: /[overview](../../../../report.md)/[divisor_size=25](../../report.md)/dataset=25_dset_20260409T105031Z
...
- IQR objective: **0.087704**
- доля успеха (`objective <= 0.678229`): **20.00%**
