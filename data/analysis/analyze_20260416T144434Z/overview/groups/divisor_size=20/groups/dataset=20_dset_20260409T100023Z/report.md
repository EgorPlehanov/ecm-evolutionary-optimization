# Отчёт анализа: `dataset=20_dset_20260409T100023Z`

## Навигация
- Путь: /[overview](../../../../report.md)/[divisor_size=20](../../report.md)/dataset=20_dset_20260409T100023Z
...
- медиана final objective: **0.675614**
- IQR objective: **0.060724**
- доля успеха (`objective <= 0.678229`): **53.33%**
