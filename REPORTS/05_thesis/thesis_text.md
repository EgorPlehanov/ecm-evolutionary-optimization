...
В ходе работы выполнены поставленные во введении задачи: проведены аналитический обзор и теоретический анализ ECM, формализован подбор B1/B2 как задача стохастической оптимизации «чёрного ящика» с ограничениями, обоснован и реализован набор эвристических методов (случайный поиск, дифференциальная эволюция, генетический алгоритм, роевой алгоритм, байесовская оптимизация), а также сформулированы практические рекомендации по применению автоматического подбора параметров ECM. Таким образом, цель работы — разработать и исследовать программную систему автоматического подбора параметров ECM с использованием эвристических методов и получить выигрыш относительно справочных параметров GMP-ECM — достигнута.
