...
Сравнение методов приведено в таблице 2.1.
...
Сравнение baseline и оптимизированных параметров приведено в таблице 4.1.
