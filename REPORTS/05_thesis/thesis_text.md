...
Рис. 4.1а Относительный выигрыш валидационной метрики по методам при широких границах поиска

![](../../data/analysis/analyze_20260519T191518Z_job7106009/overview/groups/divisor_size=20/plots/validation_gain_by_method.png)
Рис. 4.1б Относительный выигрыш валидационной метрики по методам при уточненных границах поиска
...
Рис. 4.2а Компромисс между временем оптимизации и выигрышем при широких границах поиска
...
Рис. 4.2б Компромисс между временем оптимизации и выигрышем при уточненных границах поиска
...
Рис. 4.3а Динамика сходимости лучших методов при широких границах поиска
...
Рис. 4.3б Динамика сходимости лучших методов при уточненных границах поиска
...
Рис. 4.6 Скачки улучшения лучшей оценки GA при уточненных границах поиска

На рисунке 4.7 приведен график прогресса DE при уточненных границах. Он совмещает лучшее найденное значение и неагрегированные оценки, полученные на разных этапах оптимизации. В отличие от случайного поиска, для которого характерна высокая вариативность оценок на протяжении всего процесса, популяционный метод постепенно концентрируется около более перспективных значений параметров, поэтому разброс оценок становится более содержательным для анализа локальной области.
...
Рис. 4.9 Распределение валидационной метрики для эталонных и оптимизированных параметров GA

На рисунке 4.10 приведено распределение числа кривых для PSO. Этот график выбран потому, что именно PSO дал максимальное сокращение среднего числа кривых. Распределение показывает практический смысл результата: при сохранении высокой доли успешных факторизаций оптимизированная конфигурация требует существенно меньше кривых, чем справочный режим GMP-ECM.
...
Рис. 4.10 Распределение числа кривых для эталонных и оптимизированных параметров PSO
