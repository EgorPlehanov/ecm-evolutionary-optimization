...
Рекомендуемый формат: **18 слайдов, доклад на 10-12 минут**. Структура сохраняет обязательную логику защиты, но основная часть не сжимается в один слайд: методы, система, экспериментальный дизайн и результаты вынесены в отдельные слайды.
...
- Публикации и конференционные выступления:
  - в тексте ВКР отдельные публикации и выступления не указаны;
  - если публикация, тезисы или выступление есть фактически, добавить их на этот слайд отдельным пунктом.

**О чем рассказывать:**

Говорить только то, что подтверждается материалами ВКР. Если публикаций или конференций нет, не выдумывать их; сделать акцент на экспериментальной и программной апробации результатов.
...
Показать, что ограничения работы понятны и превращены в программу дальнейших исследований. Завершить доклад благодарностью и переходом к вопросам. Если нужен отдельный чистый финальный экран, этот слайд можно разделить на два: «Перспективы» и «Спасибо за внимание».
