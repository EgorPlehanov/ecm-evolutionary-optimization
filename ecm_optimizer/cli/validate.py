...
@click.option("--opt-result-file", type=click.Path(exists=True, path_type=Path))
@click.option("--opt-b1", type=int)
@click.option("--opt-b2", type=int)
@click.option("--base-b1", type=int)
@click.option("--base-b2", type=int)
@click.option("--curves-per-n", default=DEFAULT_VALIDATION_CURVES_PER_N, show_default=True, type=int)
...
@click.option("--seed", default=DEFAULT_SEED, show_default=True, type=int, help="Reserved for deterministic experiment bookkeeping.")
